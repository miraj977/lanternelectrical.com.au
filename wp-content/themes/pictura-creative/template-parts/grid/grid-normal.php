...
<section class="grid grid-normal <?php echo $extraClass?>"  style="background-color:<?php echo get_sub_field("grid_background_color");?>;text-align:<?php echo get_sub_field('align_content');?>">
