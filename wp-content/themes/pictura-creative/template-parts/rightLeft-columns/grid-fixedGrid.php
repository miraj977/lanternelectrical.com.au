...
<section class="grid-fixedGrid <?php echo $extraClass ?>"
    style="background-color: <?php echo get_sub_field("section_background"); ?>" data-aos="fade-up">
    <div class="container">
        <div class="row">
...
$text_style = get_sub_field("align_content_in_box");?>
            ...
            <?php if (!is_front_page() && basename(get_permalink()) == "about-us") {?>

            <div class="strecth-row">

                <div class="col-md-6 col-sm-12 col-text align-self-center about-flex text-<?php echo $text_style; ?>"
                    data-aos="fade-up">
                    <div class=" ">
    ...
    $link = get_sub_field('link');
        if ($link) {$link_url = $link['url'];
            ...
            $link_target = $link['target'] ? $link['target'] : '_self';?>
                ...
                <div class="col-md-6 col-sm-12 col-img  align-self-center about-img" data-aos="fade-up">
        ...
        ?>
            ...
            <div class="strecth-row">
                ...
                <div class="col-md-6 col-sm-12 col-text align-self-center em-flex text-<?php echo $text_style; ?>"
                    data-aos="fade-up">
                    <div class=" ">
                        <?php if (get_sub_field('title')) {?>
                        <h4 class="stretched-title"><?php echo get_sub_Field('title'); ?></h4>
    ...
    $link = get_sub_field('link');
        if ($link) {$link_url = $link['url'];
            ...
            $link_target = $link['target'] ? $link['target'] : '_self';?>
                ...
                <div class="col-md-6 col-sm-12 col-img  align-self-center em-flex" data-aos="fade-up">
                    <?php $image = get_sub_field('full_image');
        $url = $image['url'];
        $title = $image['title'];
        $alt = $image['alt'];
